...
using DoctorAndPatient.Chember;
...
namespace DoctorAndPatient
{
    public class Startup
    {
        ...
        public void ConfigureContainer(ContainerBuilder builder)
        {
            ...
            builder.RegisterModule(new ChemberModule
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ChemberContext>(options =>
                options.UseSqlServer(connectionInfo.connectionString,
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "areas",
                    pattern: "{area:exists}/{controller=Chember}/{action=Index}/{Id?}");
