...
namespace DataImporter.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly IDNTCaptchaValidatorService _iDNCaptchaValidatorService;
        ...
        public AccountController(
            ...
            IDNTCaptchaValidatorService iDNCaptchaValidatorService,
          ...
          )
        {
            ...
            _iDNCaptchaValidatorService = iDNCaptchaValidatorService;
        ...
        public async Task<IActionResult> Register(RegisterModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (!_iDNCaptchaValidatorService.HasRequestValidCaptchaEntry(Language.English, DisplayMode.ShowDigits))
                {
